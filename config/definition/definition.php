...
return static function($definition)
{
    $definition->rootNode()->children()
        ...
        ->arrayNode('components')->addDefaultsIfNotSet()->children()
            ...
            ->append( (include __DIR__."/components/breadcrumb.php")() )
            ->append( (include __DIR__."/components/copyright.php")() )
            ->append( (include __DIR__."/components/navbar.php")() )
            
            ->append( (include __DIR__."/components/links.php")() )
            ->append( (include __DIR__."/components/offcanvas.php")() )
            ->append( (include __DIR__."/components/menu.php")() )
            ->append( (include __DIR__."/components/rating.php")() )
            ...
            ->append( (include __DIR__."/components/symbols.php")() )
